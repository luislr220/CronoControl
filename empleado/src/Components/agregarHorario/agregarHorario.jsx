  ...
  return (
    <div className="formulario-emergente">
      <div className="formulario-container" style={{ width: '100%', margin: '0 auto', overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>        
        ...
        <div style={{  padding: '10px 0', textAlign: 'center', overflowY: 'hidden' }}>
...
const FormularioHorario = () => {
  ...
  const filtrarHistorial = () => {
    let historialFiltrado = historial.filter((horario) => {
      return (
        horario.nombreEmpleado.toLowerCase().includes(filtroNombreEmpleado.toLowerCase()) &&
        (filtroContrato === '' || horario.contrato.toLowerCase().includes(filtroContrato.toLowerCase())) &&
        ...
        <div className="formulario-emergente">
          <div className="formulario-container" style={{ overflowY: 'auto', maxHeight: 'calc(100vh - 200px)' }}>
            ...
            <form onSubmit={handleSubmit}>
              <table style={{ width: '100%' }}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="email" id="correo" name="correo" value={formulario.correo} onChange={handleChange}  /></td>
                  </tr>
                  <tr>
              ...
              <button className="button agregar" type="submit">Enviar</button>
            </form>
